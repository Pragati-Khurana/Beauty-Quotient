...
<%@include file="commonheader.jsp"%>
    <div class="container" style="overflow-x: scroll">
        ...
        <table class="table table-striped mt32 customers-list" id="myTable">
            <thead>
                <tr>
                    <th>Offer-ID<i class="fa fa-fw fa-sort" onclick="sortTable(0)"></i></th>
                    <th>Offer Name<i class="fa fa-fw fa-sort" onclick="sortTable(1)"></i></th>
                    <th>Offer Discount<i class="fa fa-fw fa-sort" onclick="sortTable(2)"></i></th>
                    <th>Offer Valid Or Not<i class="fa fa-fw fa-sort" onclick="sortTable(3)"></i></th>
                    <th>Edit</th>
                    <th>Delete</th>
                </tr>
            </thead>
