...
<%-- 					<%=count=count+1 %> --%>
											<div class="form-group mb-3 inputBox">
												<label for="lname">Name</label><br><input type="text"
													...
													aria-describedby="emailHelp" value="<%=bookingInfo.getBookingfname()%> <%=bookingInfo.getBookinglname()%>">
											</div>
											<div class="form-group mb-3 inputBox">
												<label for="add">Address</label><br>
												<textarea rows="5" name="address" readonly style="background-color: #e6e7ee;" class="form-control1 col-lg-5" id="add"
													autocomplete="off" aria-describedby="emailHelp"><%=bookingInfo.getBookingaddress()%></textarea>
											</div>
											<div class="form-group mb-3 inputBox">
												<label for="mobilenumber">Mobile Number</label><br><input type="text"
													name="mno" readonly style="background-color: #e6e7ee;" class="form-control1 col-lg-5" id="mno" autocomplete="off"
													aria-describedby="emailHelp" value="<%=bookingInfo.getBookingcno()%>">
											</div>
										
											<div class="form-group mb-3 inputBox">
												<label for="add">Mail</label><br>
												<input value="<%=bookingInfo.getBookingemail()%>" name="address" readonly style="background-color: #e6e7ee;" class="form-control1 col-lg-5" id="add"
													autocomplete="off" aria-describedby="emailHelp">
											</div>
											<div class="form-group mb-3 inputBox">
												<label for="add">Date</label><br>
												<input value="<%=bookingInfo.getBookingdate()%>" name="address" readonly style="background-color: #e6e7ee;" class="form-control1 col-lg-5" id="add"
													autocomplete="off" aria-describedby="emailHelp">
											</div>
					...
					<form action="PgRedirect.jsp" method="post" align="center"
						...
						<div class="form-group mb-3 inputBox">
							<label for="fname">Booking ID</label><br> <input type="text"
								name="ORDER_ID" style="background-color: #e6e7ee;" readonly
								class="form-control1 col-lg-5" id="ORDER_ID" autocomplete="off"
								aria-describedby="emailHelp" value="BID_<%=bookingInfo.getBookingid()%>">
						</div>
						...
						<div class="form-group mb-3 inputBox">
							<label for="email">Total Amount</label><br> <input
								...
								aria-describedby="emailHelp" value="<%=booking.getVfees()%>">
						</div>
