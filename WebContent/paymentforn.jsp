					...
					<div class="form-group mb-3 inputBox">
											...
											<div class="form-group mb-3 inputBox">
												<label for="mobilenumber">Mobile Number</label><br><input type="text"
													...
													aria-describedby="emailHelp" value="9825857747">
											</div>
											<div class="form-group mb-3 inputBox">
												<label for="add">Area</label><br>
												<input type="text" name="address" readonly style="background-color: #e6e7ee;" class="form-control1 col-lg-5" id="add"
													autocomplete="off" aria-describedby="emailHelp" value="Ghatlodia">
											</div>
											<div class="form-group mb-3 inputBox">
												<label for="add">Mail</label><br>
												<input value="solankiarjun869@gmail.com" name="address" readonly style="background-color: #e6e7ee;" class="form-control1 col-lg-5" id="add"
					...
					<form action="PgRedirect.jsp" method="post" align="center"
						...
						<div class="form-group mb-3 inputBox">
							<label for="fname">Order ID</label><br> <input type="text"
								...
								aria-describedby="emailHelp" value="ORDS_<%=randomInt%>">
						</div>
						...
						<div class="form-group mb-3 inputBox" hidden>
							<label for="fname">Customer ID</label><br> <input
								...
								autocomplete="off" aria-describedby="emailHelp" value="CUST001">
						</div>
						<div class="form-group mb-3 inputBox" hidden>
